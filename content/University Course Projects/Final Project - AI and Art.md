...
How can AI be used ethically and as a collaborative tool in the creative process without diminishing the role of human artistic expression and authorship? In this video essay I will discuss the history and ethical concerns of using AI in creativity. I believe AI can be greatly beneficial to the creative process and therefore I will discuss ways to ethically and authentically use AI to enhance your creative experience.

### **VIDEO ESSAY**

![[CTS1000 FINAL PROJECT4.mp4]]
### **TRANSCRIPT**

|   |   |
|---|---|
|**Audio**|**Visual Direction**|
|Well some of the worlds biggest bands are speaking out against artificial intelligence. Musicians, actors, and authors have signed a protest letter against AI's use of their work... The Bank of Canada says there is a lot of uncertainty around how artificial intelligence could effect the economy moving forward... its not to say that there is not great potential in them, we cannot being this; its stealing peoples work... We are talking right now about artificial intelligence or AI, its becoming more prevalent throughout our society, and some people are concerned about the effects that it could have on multiple jobs. Especially those with more creative jobs such as artists and writers who worry that these AI tools could completely replace them and their need for their skill.|Various News clips from CTV, Global News, and Erie News Now (CTV, 2024) (Global News, 2023) (Erie News Now, 2023).|
|Welcome to my living room. Today's video essay will discuss how can AI be used ethically and as a collaborative tool in the creative process without diminishing the role of human artistic expression and authorship?<br><br>  <br><br>First lets start off with what exactly is AI and how it came to be so prevalent today.|Female sitting on a beige couch holding a microphone|
|...|A fast montage of AI art and famous paintings, slowing down to one image of comparing Greg Rutowski's work to an AI prompt of his work. Last image credit: Rutkowski’s “Castle Defense, 2018” (left) and a Stable Diffusion prompted image) (Other image credits in the bibliography)|
|"Artificial intelligence (AI) is the theory and development of computer systems capable of performing tasks that historically required human intelligence, such as recognizing speech, making decisions, and identifying patterns" (Coursera Staff, 2024). AI encompasses a variety of technology including natural language processing, machine learning, and deep learning. This technology is possible through the AI models learning using algorithms trained on datasets.|Female sitting on a beige couch holding a microphone|
|The most common examples of AI today are ChatGPT, smart assistants, google translate, autonomous vehicles, and social media dynamic algorithms|Person is on their phone using google maps, chatbot, and in a self-driving car.|
|Artificial intelligence has become prevalent across many industries by automating tasks to save money and time. With the increase in accessibilty of these AI tools it has become an essential skill for the workforce. I myself am signed up to do a AI ethics and productivity webinar this December.|Office setting|
|The creative process can look different for every artist and the creative process tends to be chaotic and nonlinear (Gregoire, 2019). Although there is no formula, Carolyn Gregoire describes the four most popular stages that can take place in the creative process.|Female sitting on a beige couch holding a microphone|
|Stage 1 is preparation. This stage is gathering information and materials to identify sources of inspiration.|Title image that says "Stage 1: Preparation"|
|Stage 2 is incubation. This stage is when all those ideas marinate and create new connections.|Title image that says "Stage 2: Incubation"|
|Stage 3 is illumination. This is the aha moment when the ideas come together to form a creative breakthrough as a solution to your creative problem.|Title image that says "Stage 3: Illumination"|
|Stage 4 is verification. This is where the vision is put to paper, and the making starts, the idea is fleshed out and developed.|Title image that says "Stage 4: Verification"|
|Lastly this topic of AI and art focuses around the keyword of "make" which is "to produce (a material thing) by combination of parts, or by giving a certain form to a portion of matter, to manufacture; to construct, assemble, frame, fashion (OED, 2024).|Title image of the Oxford English Dictionary definition on "make."|
|Now that your all caught up, lets go back to the first comparison image I briefly showed you.|Female sitting on a beige couch holding a microphone|
|Take Greg Rutkowski, a renowned Polish artist known for his stunning fantasy landscapes. His unique style has captivated audiences worldwide. Unfortunately, his work has also been exploited. He has been struggling with AI illegally using this art to train its programs (Heikkila, 2022).|Image comparing Greg Rutkowski's work to an AI prompt of his work|
|Melissa Heikkila says that "His distinctive style is now one of the most commonly used prompts in the new open-source AI art generator Stable Diffusion"<br><br>  <br><br>This is not an isolated incident. Many artists have found their works used without permission to train AI systems. If you’re an artist, you can check if your work has been stolen at websites like [HaveIBeenTrained.com](http://haveibeentrained.com/)|Home page of HaveIBeenTrained website andImages of Greg Rutkowski's portfolio work (Rutkowski, 2024).|
|The harm doesn’t stop at art theft. The rise of AI-generated content threatens to dampen creative ambition. Why hire an artist when you can generate an image in seconds? This puts artists and photographers at risk of losing income and devalues their craft.<br><br>  <br><br>Artificial Intelligence is revolutionizing the creative world, but not without controversy. For many artists, AI isn’t just a tool—it’s a threat to their livelihoods and creative rights.|Female sitting on a beige couch holding a microphone|
...
Pope, Alex. “AI Artwork of Alan Turing Sells for $1m at Auction.” _BBC_, 7 Nov. 2024, [www.bbc.com/news/articles/cpqdvz4w45wo](http://www.bbc.com/news/articles/cpqdvz4w45wo).
